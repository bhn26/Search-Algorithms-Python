...
#DLS takes in a list representation of the board and runs a depth
#limited search algorithm on it.
def DLS(board):
	...
	#Initializes the max depth of the alg
	MD = 5
